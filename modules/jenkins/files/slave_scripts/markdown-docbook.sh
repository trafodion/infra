...
# Filenames for the known repos that could do this are trafodionapi-programming.mdown
# and images-api-v2.0.md and trafodionapi-programming and images-api-v2.0 are the names
