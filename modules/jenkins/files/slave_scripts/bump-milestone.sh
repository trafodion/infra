...
# refs/meta/trafodion/release.  Because it's not under refs/heads, a
...
# push directly to refs/meta/trafodion/*.

GIT_HOST="review.trafodion.org:29418"
PROJECT_PREFIX="trafodion"
...
# Checkout or create the meta/trafodion/release branch
if ! { git branch -a |grep ^[[:space:]]*remotes/meta/trafodion/release$; }
then
  ...
  git checkout -b release remotes/meta/trafodion/release
fi
...
git push origin HEAD:refs/meta/trafodion/release
