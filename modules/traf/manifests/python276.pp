...
class traf::python276 {
  ...
  exec { 'pip_install_python-novaclient' :
      path        => '/usr/local/bin:/usr/bin:/bin',
      environment => 'PYTHONHOME=/usr/local',
      command     => 'pip install python-novaclient==2.17.0',
      creates     => '/usr/local/bin/nova',
      unless      => "pip freeze | grep 'python-novaclient==2.17.0'",
      require     => Exec['run_get-pip.py'],
  }

  exec { 'pip_install_python-swiftclient' :
      path        => '/usr/local/bin:/usr/bin:/bin',
      environment => 'PYTHONHOME=/usr/local',
      command     => 'pip install python-swiftclient==2.1.0',
      creates     => '/usr/local/bin/swift',
      unless      => "pip freeze | grep 'python-swiftclient==2.1.0'",
      require     => Exec['run_get-pip.py'],
  }

  exec { 'pip_install_python-cinderclient' :
      path        => '/usr/local/bin:/usr/bin:/bin',
      environment => 'PYTHONHOME=/usr/local',
      command     => 'pip install python-cinderclient==1.0.8',
      creates     => '/usr/local/bin/cinder',
      unless      => "pip freeze | grep 'python-cinderclient==1.0.8'",
      require     => Exec['run_get-pip.py'],
  }

  exec { 'pip_install_python-glanceclient' :
      path        => '/usr/local/bin:/usr/bin:/bin',
      environment => 'PYTHONHOME=/usr/local',
      command     => 'pip install python-glanceclient==0.12.0',
      creates     => '/usr/local/bin/glance',
      unless      => "pip freeze | grep 'python-glanceclient==0.12.0'",
      require     => Exec['run_get-pip.py'],
  }

  exec { 'pip_install_python-neutronclient' :
      path        => '/usr/local/bin:/usr/bin:/bin',
      environment => 'PYTHONHOME=/usr/local',
      command     => 'pip install python-neutronclient==2.3.4',
      creates     => '/usr/local/bin/neutron',
      unless      => "pip freeze | grep 'python-neutronclient==2.3.4'",
      require     => Exec['run_get-pip.py'],
  }

  exec { 'pip_install_python-designateclient' :
      path        => '/usr/local/bin:/usr/bin:/bin',
      environment => 'PYTHONHOME=/usr/local',
      command     => 'pip install python-designateclient==1.0.0',
      creates     => '/usr/local/bin/designate',
      unless      => "pip freeze | grep 'python-designateclient==1.0.0'",
      require     => Exec['run_get-pip.py'],
  }

  exec { 'pip_install_python-keystoneclient' :
      path        => '/usr/local/bin:/usr/bin:/bin',
      environment => 'PYTHONHOME=/usr/local',
      command     => 'pip install python-keystoneclient==0.4.1',
      creates     => '/usr/local/bin/keystone',
      unless      => "pip freeze | grep 'python-keystoneclient==0.4.1'",
      require     => [
        Exec['run_get-pip.py'], Exec['pip_install_python-novaclient'],
        Exec['pip_install_python-swiftclient'], Exec['pip_install_python-cinderclient'],
        Exec['pip_install_python-glanceclient'], Exec['pip_install_python-neutronclient'],
        Exec['pip_install_python-designateclient'],
      ],
  }
