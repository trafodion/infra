...
class SkinVector extends SkinTemplate {
	...
	public function initPage( OutputPage $out ) {
        ...
        // The following appears to add the metrics script to the wiki but the wiki does not appear to use it
        //$out->addHeadItem( 'hp-metrics.js', "\n" . '<script language="JavaScript" type="text/javascript" src="https://secure.hp-ww.com/cma/ng/lib/bootstrap/metrics.js"></script>' . "\n" );
        //$out->addHeadItem( 'hp-metrics.js', "\n" . '<script language="JavaScript" type="text/javascript" src="http://welcome.hp-ww.com/cma/ng/lib/bootstrap/metrics.js"></script>' . "\n" );
...
<div id="p-variants" role="navigation" class="vectorMenu<?php if ( count( $this->data['variant_urls'] ) == 0 ) { echo ' emptyPortlet'; } ?>" aria-labelledby="p-variants-label">
	<?php if ( count( $this->data['variant_urls'] ) != 0 ) { echo '<h3 id="mw-vector-current-variant">'; } ?>
	<?php foreach ( $this->data['variant_urls'] as $link ) { ?>
		<?php if ( stripos( $link['attributes'], 'selected' ) !== false ) { ?>
			<?php echo htmlspecialchars( $link['text'] ) ?>
		<?php } ?>
	<?php } ?>
	<?php if ( count( $this->data['variant_urls'] ) != 0 ) { echo '</h3>'; } ?>
	<h3 id="p-variants-label"><span><?php $this->msg( 'variants' ) ?></span><a href="#p-variants-label"></a></h3>
	<div class="menu">
		<ul>
			<?php foreach ( $this->data['variant_urls'] as $link ) { ?>
...
<div id="p-cactions" role="navigation" class="vectorMenu<?php if ( count( $this->data['action_urls'] ) == 0 ) { echo ' emptyPortlet'; } ?>" aria-labelledby="p-cactions-label">
	<h3 id="p-cactions-label"><span><?php $this->msg( 'actions' ) ?></span><a href="#p-cactions-label"></a></h3>
	<div class="menu">
		<ul<?php $this->html( 'userlangattributes' ) ?>>
